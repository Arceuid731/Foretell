...
requirements = {
    ...
    "BossMod/Foretell/ForetellGuideWorkspace.cs": [
    ...
    "BossMod/Foretell/ForetellInspector.cs": [
        '"###Instance", DrawInstanceDashboard)',
        '"###Guides", DrawGuideManager)',
        '"###LocalAI", DrawGuideModelManager)',
        '"###Display", DrawInspectorSettings)',
        '"###Advanced", DrawGuideAdvanced)',
        "finally { ImGui.EndTabBar(); }",
